...
valid_counts_by_sample <- imap(
  dfs,
  ~ {
    id_col <- if (.y == "chimps") "session_trial" else "trial"
    count_valid_trials(.x, trial_id_col = id_col) |>
      mutate(sample = .y)
  }
)

valid_counts_all <- bind_rows(valid_counts_by_sample)

valid_summary <- valid_counts_all |>
  group_by(sample) |>
  summarise(
...
saveRDS(valid_summary, here("exp1", "doc", "tables", "valid_summary.rds"))
...
#   
#   df_temp <- read.table(
#     here("data", "preproc_included_2", "chimps_2p", filename),
#     header = T,
#     sep = "\t"
#   ) |>
#     mutate(age_group = "apes (2-point ape calibration)")
#   
#   df_temp_etoutcome <- read.table(
#     here("data", "preproc_included_2", "chimps_2p", filename),
#     header = T,
#     sep = "\t"
#   ) |>
...
#     
#     df_temp <- read.table(
#       here("data", "preproc_included_2", age_group, filename),
#       header = T,
#       sep = "\t"
#     ) |>
...
#   dplyr::summarize(
#     sd_acc_visd = sd(mean_acc_visd, na.rm = T),
...
#     mean_acc_visd = mean(acc_visd, na.rm = T)
#   )
# 
# ## dplyr::summarize Precision (RMS) ----
# precrms_mean_sd <- mean_sd(precrms_tot, c("age_group", "filename"), "precrms_visd")
# precrms_mean_sd_2 <- mean_sd(precrms_tot,
#                              c("age_group", "filename", "position"),
#                              "precrms_visd")
# precrms_mean_sd_2 <- precrms_mean_sd_2 |>
#   group_by(age_group, position) |>
#   dplyr::summarize(
#     sd_precrms_visd = sd(mean_precrms_visd, na.rm = T),
...
#     mean_precrms_visd = mean(precrms_visd, na.rm = T)
#   )
# 
...
# ## Inference Accuracy ----
# t.test(
#   acc_mean_sd |> filter(age_group == "4") |> pull(mean_acc_visd),
#   acc_mean_sd |> filter(age_group == "6") |> pull(mean_acc_visd),
#   paired = F
# )
# t.test(
#   acc_mean_sd |> filter(age_group == "4") |> pull(mean_acc_visd),
#   acc_mean_sd |> filter(age_group == "9") |> pull(mean_acc_visd),
#   paired = F
# )
# t.test(
#   acc_mean_sd |> filter(age_group == "4") |> pull(mean_acc_visd),
#   acc_mean_sd |> filter(age_group == "18") |> pull(mean_acc_visd),
#   paired = F
# )
# t.test(
#   acc_mean_sd |> filter(age_group == "4") |> pull(mean_acc_visd),
#   acc_mean_sd |> filter(age_group == "adult") |> pull(mean_acc_visd),
#   paired = F
# )
# 
# t.test(
...
# 
# t.test(
#   acc_mean_sd |> filter(age_group == "apes (2-point ape calibration)") |> pull(mean_acc_visd),
#   acc_mean_sd |> filter(age_group == "4") |> pull(mean_acc_visd),
#   paired = F
# )
# t.test(
...
# 
# t.test(
#   acc_mean_sd |> filter(age_group == "apes (5-point alex calibration)") |> pull(mean_acc_visd),
#   acc_mean_sd |> filter(age_group == "4") |> pull(mean_acc_visd),
#   paired = F
# )
# t.test(
...
# 
# t.test(
#   acc_mean_sd |> filter(age_group == "apes (9-point human calibration)") |> pull(mean_acc_visd),
#   acc_mean_sd |> filter(age_group == "4") |> pull(mean_acc_visd),
#   paired = F
# )
# t.test(
...
# ## Inference RMS ----
# t.test(
#   precrms_mean_sd |> filter(age_group == "4") |> pull(mean_precrms_visd),
#   precrms_mean_sd |> filter(age_group == "6") |> pull(mean_precrms_visd),
#   paired = F
# ) # s
# t.test(
#   precrms_mean_sd |> filter(age_group == "4") |> pull(mean_precrms_visd),
#   precrms_mean_sd |> filter(age_group == "9") |> pull(mean_precrms_visd),
#   paired = F
# ) # s
# t.test(
#   precrms_mean_sd |> filter(age_group == "4") |> pull(mean_precrms_visd),
#   precrms_mean_sd |> filter(age_group == "18") |> pull(mean_precrms_visd),
#   paired = F
# ) # s
# t.test(
#   precrms_mean_sd |> filter(age_group == "4") |> pull(mean_precrms_visd),
#   precrms_mean_sd |> filter(age_group == "adult") |> pull(mean_precrms_visd),
#   paired = F
# ) # s
# 
# t.test(
...
# 
# t.test(
#   precrms_mean_sd |> filter(age_group == "apes (2-point ape calibration)") |> pull(mean_precrms_visd),
#   precrms_mean_sd |> filter(age_group == "4") |> pull(mean_precrms_visd),
#   paired = F
# ) # s
# t.test(
...
# t.test(
#   precrms_mean_sd |> filter(age_group == "apes (2-point ape calibration)") |> pull(mean_precrms_visd),
#   precrms_mean_sd |> filter(age_group == "apes (5-point alex calibration)") |> pull(mean_precrms_visd),
#   paired = F
# ) # ns
# t.test(
#   precrms_mean_sd |> filter(age_group == "apes (5-point alex calibration)") |> pull(mean_precrms_visd),
...
# 
# t.test(
#   precrms_mean_sd |> filter(age_group == "apes (9-point human calibration)") |> pull(mean_precrms_visd),
#   precrms_mean_sd |> filter(age_group == "4") |> pull(mean_precrms_visd),
#   paired = F
# ) # s
# t.test(
...
#   bind_rows(
#     replicate(
#       df_tot_chimps_2p$filename |> unique() |> length() - 1,
#       all_trials,
#       simplify = FALSE
#     )
#   ) |>
...
#   group_by(filename) |>
#   dplyr::summarize(
#     intertrial_sd = sd(precrms_visd, na.rm = TRUE),
...
#         "18",
#         "adult",
#         "apes (2-point ape calibration)",
#         "apes (9-point human calibration)"
#       )
#     )) |>
#     group_by(age_group) |> dplyr::summarize(
#       sd_acc_visd = sd(mean_acc_visd, na.rm = T),
#       mean_acc_visd = mean(mean_acc_visd, na.rm = T)
#     ),
#   mean_col = "mean_acc_visd",
#   sd_col = "sd_acc_visd",
#   plot_title = "Eye Tracking Data Quality (Accuracy) (Preliminary Results) (The Greater, The Worse)",
#   x_label = "Accuracy in Visual Degree",
#   x_lim = c(0, 8)
# )
# 
...
#     color = "black"
#   ) +
#   labs(title = "Accuracy", x = "Group", y = "Accuracy\n(distance from center in visual degrees)") +
#   theme_minimal() +
#   scale_fill_manual(
#     values = c(
#       "4" = "red",
#       # Age group 4 in red
#       "6" = "mediumblue",
#       # Age group 6 in mediumdark blue
#       "9" = "lightgreen",
#       # Age group 9 in intense green
#       "18" = "yellow",
#       # Age group 18 in yellow
#       "adult" = "purple",
#       # Age group adult in purple
#       "apes\n(2 points\napes)" = "salmon3",
#       "apes\n(9 points\nhumans)" = "grey",
#       "apes\n(5 points\nalex)" = "orange"
#     )
...
#   mutate(
#     age_group = case_when(
#       age_group == "apes (2-point ape calibration)" &
#         str_detect(filename, str_c(juvenile_names, collapse = "|")) ~ "apes (juveniles)",
#       age_group == "apes (2-point ape calibration)" &
#         str_detect(filename, str_c(adult_names, collapse = "|")) ~ "apes (adults)",
#       TRUE ~ age_group
#     )
#   ) |>
...
#     mutate(age_group = factor(
#       age_group,
#       levels = c("4", "6", "9", "18", "adult", "apes (juveniles)", "apes (adults)"),
#       labels = c(
#         "4",
#         "6",
#         "9",
...
# 
# # Plot per position
# acc_mean_sd_2$position <- factor(
#   acc_mean_sd_2$position,
#   levels = c(
#     "center",
#     "topleft",
#     "top",
...
#   )
# )
# acc_mean_sd_2$age_group <- factor(
#   acc_mean_sd_2$age_group,
#   levels = c(
#     "4",
#     "6",
#     "9",
...
#        aes(x = position, y = mean_acc_visd, color = age_group)) +
#   geom_errorbar(
#     aes(ymin = mean_acc_visd - sd_acc_visd, ymax = mean_acc_visd + sd_acc_visd),
#     width = 0.2,
...
# plot_distribution_rq1(
#   data = precrms_mean_sd |> mutate(age_group = factor(
#     age_group, levels = c("4", "6", "9", "18", "adult")
#   )) |> group_by(age_group) |>
#     dplyr::summarize(
#       sd_precrms_visd = sd(mean_precrms_visd, na.rm = T) ,
#       mean_precrms_visd = mean(mean_precrms_visd, na.rm = T)
#     ),
#   mean_col = "mean_precrms_visd",
#   sd_col = "sd_precrms_visd",
#   plot_title = "Normal Distributions of Precision (RMS) by Age Group",
#   x_label = "Precision (RMS) in Visual Degree",
#   x_lim = c(0, 2)
# )
# 
...
#       labs(title = fname, y = "Mean Accuracy") +
#       theme_minimal()
#   })
# 
...
#       geom_line(color = "darkgrey") +
#       geom_point(color = "steelblue", size = 2) +
#       labs(title = fname, y = "Mean Precision (RMS)") +
#       theme_minimal()
#   })
# 
# combined_plot <- wrap_plots(plots) +
#   plot_layout(ncol = 3)  # Adjust number of columns as needed
# png(
#   here("img", "precrms_session_1.png"),
#   width = 2048,
#   height = 2048 + 1152,
#   res = 300
# )
...
# 
# png(
#   here("img", "precrms_session_2.png"),
#   width = 2048,
#   height = 1152,
#   res = 300
# )
# ggplot(
#   precrms_mean_sd_3_session |> group_by(session) |> dplyr::summarize(
#     sd_precrms_visd = sd(mean_precrms_visd, na.rm = T),
#     mean_precrms_visd = mean(mean_precrms_visd, na.rm = T),
#     n = n_apes_session,
...
#                 width = 0.2,
#                 color = "darkgrey") +
#   labs(x = "Session", y = "Mean Precision (RMS)", title = "Average Precision (RMS) Across Individuals per Session") +
#   theme_minimal()
# dev.off()
# 
# # Plot the session-wise average
...
# 
# png(
#   here("img", "acc_session_2.png"),
#   width = 2048,
#   height = 1152,
#   res = 300
# )
# ggplot(
#   acc_mean_sd_3_session |> group_by(session) |> dplyr::summarize(
#     sd_acc_visd = sd(mean_acc_visd, na.rm = T),
#     mean_acc_visd = mean(mean_acc_visd, na.rm = T),
#     n = n_apes_session,
...
#                 width = 0.2,
#                 color = "darkgrey") +
#   labs(x = "Session", y = "Mean Accuracy", title = "Average Accuracy Across Individuals per Session") +
#   theme_minimal()
# dev.off()
# 
# ## RQ 2 ----
# png(
#   here("img", "rq2_acc_rellt.png"),
#   width = 2048,
#   height = 2048,
#   res = 300
# )
...
#   df_tot |>
#     filter(!(
#       age_group %in% c("apes (9-point human calibration)")
#     )) |>
#     mutate(age_group = factor(
#       age_group,
#       levels = c("4", "6", "9", "18", "adult", "apes (2-point ape calibration)")
#     )) |>
#     group_by(age_group, filename) |>
#     dplyr::summarize(
#       acc_visd = mean(acc_visd, na.rm = T),
#       rel_gaze_in_aoi = mean(rel_gaze_in_aoi, na.rm = T)
#     ) |>
#     ungroup(),
#   aes_string(x = "acc_visd", y = "rel_gaze_in_aoi")
# ) +
#   geom_point() +
...
# 
# png(
#   here("img", "rq2_precrms_rellt.png"),
#   width = 2048,
#   height = 2048,
#   res = 300
# )
...
#     ) |>
#     ungroup(),
#   aes_string(x = "precrms_visd", y = "rel_gaze_in_aoi")
# ) +
#   geom_point() +
#   geom_smooth(method = "lm",
#               se = FALSE,
...
# 
# png(
#   here("img", "rq2_precrms_fixdur.png"),
#   width = 2048,
#   height = 2048,
#   res = 300
# )
...
#     dplyr::summarize(
#       precrms_visd = mean(precrms_visd, na.rm = T),
#       mean_fixation_duration = mean(mean_fixation_duration, na.rm = T)
#     ) |>
#     ungroup(),
#   aes_string(x = "precrms_visd", y = "mean_fixation_duration")
# ) +
#   geom_point() +
#   geom_smooth(method = "lm",
#               se = FALSE,
...
#     ) |>
#     ungroup(),
#   aes_string(x = "acc_visd", y = "mean_fixation_duration")
# ) +
#   geom_point() +
#   geom_smooth(method = "lm",
#               se = FALSE,
...
# # Create the plot
# ggplot(acc_mean_sd_2 |>  mutate(position = factor(
#   position,
#   levels = c(
#     "center",
#     "top",
...
#   labs(x = "Position", y = "Mean Accuracy", title = "Mean Accuracy per Position by Age Group") +
#   theme_minimal() +
#   theme(axis.text.x = element_text(angle = 45, hjust = 1))
# 
# 
...
#   labs(x = "Position", y = "Mean Accuracy", title = "Mean Accuracy per Position by Age Group (with 95% CI)") +
#   ylim(0.2, 1.8) +
#   theme_minimal() +
#   theme(axis.text.x = element_text(angle = 45, hjust = 1))
# dev.off()
...
# # Create the plot
# ggplot(
#   precrms_mean_sd_2 |>  mutate(position = factor(
#     position,
#     levels = c(
#       "center",
#       "top",
...
#   geom_col(fill = "steelblue") +
#   facet_wrap( ~ age_group, scales = "free_y") +
#   labs(x = "Position", y = "Mean Precision", title = "Mean Precision per Position by Age Group") +
#   theme_minimal() +
#   theme(axis.text.x = element_text(angle = 45, hjust = 1))
# 
# 
...
# 
# png(
#   here("img", "precrms_position_1.png"),
#   width = 2048 + 1024,
#   height = 1152,
#   res = 300
# )
...
#   geom_point(size = 2, color = "steelblue") +
#   facet_wrap( ~ age_group, scales = "free_y", nrow = 1) +
#   labs(x = "Position", y = "Mean Precision", title = "Mean Precision per Position by Age Group (with 95% CI)") +
#   ylim(0, 2) +
#   theme_minimal() +
#   theme(axis.text.x = element_text(angle = 45, hjust = 1))
# dev.off()
# 
# png(
#   here("img", "precrms_position_2.png"),
#   width = 2048,
#   height = 1152,
#   res = 300
# )
...
#   ) |>
#   pivot_longer(
#     cols = c("alina", "daniela", "matthias", "hanna", "marie", "josefine"),
#     names_to = "calibration",
#     values_to = "accuracy"
#   ) |>
#   group_by(filename) |>
...
#   pivot_longer(cols = c("human_acc", "alex_acc", "ape_acc"),
#                values_to = "accuracy") |>
...
# 
# png(
#   here("img", "acc_ape2p_vs_human9p.png"),
#   width = 2048 / 1.5,
#   height = 1152,
#   res = 300
# )
# ggplot(
#   ape_averaged_acc4 |> filter(name %in% c(
#     "Human Calibration (9p)", "Ape Calibration (2p)"
#   )),
#   aes(
#     x = name,
#     y = accuracy,
...
#   geom_point(size = 1.5) +
#   labs(
#     title = paste0("Ape: ", ape_averaged_acc5[2], ". Human: ", ape_averaged_acc5[3], "."),
#     x = NULL,
#     y = "Mean Accuracy",
#     color = "Individual"
#   ) +
...
# 
# png(
#   here("img", "acc_ape2p_vs_alex5p.png"),
#   width = 2048 / 1.5,
#   height = 1152,
#   res = 300
# )
# ggplot(
#   ape_averaged_acc4 |> filter(name %in% c(
#     "Alex Calibration (5p)", "Ape Calibration (2p)"
#   )) |>
#     mutate(name = factor(
#       name, levels = c("Ape Calibration (2p)", "Alex Calibration (5p)")
#     )),
#   aes(
#     x = name,
#     y = accuracy,
...
#   geom_point(size = 1.5) +
#   labs(
#     title = paste0("Alex: ", ape_averaged_acc5[1], ". Apes: ", ape_averaged_acc5[2], "."),
#     x = NULL,
#     y = "Mean Accuracy",
#     color = "Individual"
#   ) +
...
# 
# png(
#   here("img", "precrms_daniela_1.png"),
#   width = 2048,
#   height = 1152,
#   res = 300
# )
...
# 
# png(
#   here("img", "precrms_josefine_1.png"),
#   width = 2048,
#   height = 1152,
#   res = 300
# )
...
# 
# png(
#   here("img", "precrms_matthias_1.png"),
#   width = 2048,
#   height = 1152,
#   res = 300
# )
...
# )
# 
# g_acc_1 <- ggplot(df_plot |> filter(
#   age_group %in% c("4", "6", "9", "18", "adult", "chimpanzees\n(2 points\napes)")
# ),
...
#     mutate(age_group = factor(
#       age_group,
#       levels = c("4", "6", "9", "18", "adult", "chimpanzees\n(2 points\napes)"),
...
# 
# png(
#   here("img", "paperplot_rq3_accuracy_350.png"),
#   width = 2048,
#   height = 1152,
#   res = 350
# )
