...
## Model Fit: Posterior Predictive Check ----
# Check whether model is "match to the data"
png(here("exp2", "img", "rq1_precsd_ppc.png"), width = 2480/2, height = 3508/2, res = 200)
pp_check(full_rq1_precsd, ndraws = 100) 
#pp_check(full_rq1_precsd, type = "hist")
dev.off()

png(here("exp2", "img", "rq1_precsd_ppc_grouped.png"), width = 2480/2, height = 3508/2, res = 200)
...
png(here("exp2", "img", "rq1_precsd_posterior.png"), width = 2480/2, height = 3508/2.5, res = 200)
...
png(here("exp2", "img", "rq1_precsd_paperplot.png"), width = 2480/2, height = 3508/4, res = 200)
p_precsd
dev.off()
...
## Model Fit: Posterior Predictive Check ----
# Check whether model is "match to the data"
png(here("exp2", "img", "rq1_rob_ppc.png"), width = 2480/2, height = 3508/2, res = 200)
pp_check(full_rq1_rob, ndraws = 100) 
#pp_check(full_rq1_rob, type = "hist")
dev.off()

png(here("exp2", "img", "rq1_rob_ppc_grouped.png"), width = 2480/2, height = 3508/2, res = 200)
...
# Save
png(here::here("exp2", "img", "rq1_rob_posterior.png"), width = 2480, height = 3508/4, res = 250)
...
# Plot prior and posterior distribution to see how sensitive the results are to the choice of priors
png(here("exp2", "img", "rq1_rob_posteriorprior_chimps.png"), width = 2480/2, height = 3508/3, res = 300)
plot_prior_vs_poster(full_rq1_rob, pars = c("b_folderchimps", "prior_b_folderchimps"), facet_label = "Chimpanzees")
dev.off()

png(here("exp2", "img", "rq1_rob_posteriorprior_4m.png"), width = 2480/2, height = 3508/3, res = 300)
plot_prior_vs_poster(full_rq1_rob, pars = c("b_folder4m", "prior_b_folder4m"), facet_label = "4-Month-Olds")
dev.off()

png(here("exp2", "img", "rq1_rob_posteriorprior_6m.png"), width = 2480/2, height = 3508/3, res = 300)
plot_prior_vs_poster(full_rq1_rob, pars = c("b_folder6m", "prior_b_folder6m"), facet_label = "6-Month-Olds")
dev.off()

png(here("exp2", "img", "rq1_rob_posteriorprior_9m.png"), width = 2480/2, height = 3508/3, res = 300)
plot_prior_vs_poster(full_rq1_rob, pars = c("b_folder9m", "prior_b_folder9m"), facet_label = "9-Month-Olds")
dev.off()

png(here("exp2", "img", "rq1_rob_posteriorprior_18m.png"), width = 2480/2, height = 3508/3, res = 300)
plot_prior_vs_poster(full_rq1_rob, pars = c("b_folder18m", "prior_b_folder18m"), facet_label = "18-Month-Olds")
dev.off()

png(here("exp2", "img", "rq1_rob_posteriorprior_adults.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq1_rob_paperplot.png"), width = 2480/2, height = 3508/4, res = 200)
p_robust
dev.off()
...
posterior_robust <- mcmc_areas(ep, pars = rev(pars_order), prob = 0.95) +
  ...
  ggplot2::labs(x = "Robustness\n(Posterior Predictive Mean; Response Scale)",
                y = "Group")
png(here("exp2", "img", "rq1_rob_posteriorplot.png"), width = 2480/2, height = 3508/4, res = 250)
posterior_robust
dev.off()
...
png(here("exp2", "img", "rq2_acc_hum_ppc.png"), width = 2480/2, height = 3508/2, res = 200)
pp_check(full_rq2_acc_hum, ndraws = 100)
dev.off()

png(here("exp2", "img", "rq2_acc_chi1_ppc.png"), width = 2480/2, height = 3508/2, res = 200)
pp_check(full_rq2_acc_chi, ndraws = 100)
dev.off()

png(here("exp2", "img", "rq2_acc_chi2_ppc.png"), width = 2480/2, height = 3508/2, res = 200)
pp_check(full_rq2_acc_chi_2, ndraws = 100)
dev.off()

png(here("exp2", "img", "rq2_acc_hum_ppc_grouped.png"), width = 2480/2, height = 3508/2, res = 200)
...
plot_rq2(df = df_tot, png_name = "rq2_acc_session_all.png", out_dir = here::here("exp2", "img"), width = 2480*1.5, height = 3508, res = 300,
...
plot_rq2(df = df_tot, png_name = "rq2_acc_trial_all.png", out_dir = here::here("exp2", "img"), width = 2480*1.5, height = 3508, res = 300,
...
plot_rq2(df = df_tot, png_name = "rq2_acc_day_all.png", out_dir = here::here("exp2", "img"), width = 2480*1.5, height = 3508, res = 300,
...
for (page in 1:n_pages) {
  ...
  ggsave(
    filename = file.path(here("exp2", "img", paste0("individual_acc_visd_plots_page_", page, ".png"))
    ),
    plot = p_rq2_acc,
    width = 11,
    height = 8.5,
...
## Model Fit: Posterior Predictive Check ----
# Check whether model is "match to the data"
png(here("exp2", "img", "rq2_precrms_hum_ppc.png"), width = 2480/2, height = 3508/2, res = 200)
pp_check(full_rq2_precrms_hum, ndraws = 100)
dev.off()

png(here("exp2", "img", "rq2_precrms_chi1_ppc.png"), width = 2480/2, height = 3508/2, res = 200)
pp_check(full_rq2_precrms_chi, ndraws = 100)
dev.off()

png(here("exp2", "img", "rq2_precrms_chi2_ppc.png"), width = 2480/2, height = 3508/2, res = 200)
pp_check(full_rq2_precrms_chi_2, ndraws = 100)
dev.off()

png(here("exp2", "img", "rq2_precrms_hum_ppc_grouped.png"), width = 2480/2, height = 3508/2, res = 200)
...
## Paper Plot ----
plot_rq2(df = df_tot, png_name = "rq2_precrms_session_all.png", out_dir = here::here("exp2", "img"), width = 2480*1.5, height = 3508, res = 300,
...
plot_rq2(df = df_tot, png_name = "rq2_precrms_trial_all.png", out_dir = here::here("exp2", "img"), width = 2480*1.5, height = 3508, res = 300,
...
plot_rq2(df = df_tot, png_name = "rq2_precrms_day_all.png", out_dir = here::here("exp2", "img"), width = 2480*1.5, height = 3508, res = 300,
...
for (page in 1:n_pages) {
  ...
  ggsave(
    filename = file.path(here("exp2", "img", paste0("individual_precrms_visd_plots_page_", page, ".png"))
    ),
    plot = p_rq2_precrms,
    width = 11,
    height = 8.5,
...
## Model Fit: Posterior Predictive Check ----
# Check whether model is "match to the data"
png(here("exp2", "img", "rq2_precsd_hum_ppc.png"), width = 2480/2, height = 3508/2, res = 200)
pp_check(full_rq2_precsd_hum, ndraws = 100)
dev.off()

png(here("exp2", "img", "rq2_precsd_chi1_ppc.png"), width = 2480/2, height = 3508/2, res = 200)
pp_check(full_rq2_precsd_chi, ndraws = 100)
dev.off()

png(here("exp2", "img", "rq2_precsd_chi2_ppc.png"), width = 2480/2, height = 3508/2, res = 200)
pp_check(full_rq2_precsd_chi_2, ndraws = 100)
dev.off()

png(here("exp2", "img", "rq2_precsd_hum_ppc_grouped.png"), width = 2480/2, height = 3508/2, res = 200)
...
## Paper Plot ----
plot_rq2(df = df_tot, png_name = "rq2_precsd_session_all.png", out_dir = here::here("exp2", "img"), width = 2480*1.5, height = 3508, res = 300,
...
plot_rq2(df = df_tot, png_name = "rq2_precsd_trial_all.png", out_dir = here::here("exp2", "img"), width = 2480*1.5, height = 3508, res = 300,
...
plot_rq2(df = df_tot, png_name = "rq2_precsd_day_all.png", out_dir = here::here("exp2", "img"), width = 2480*1.5, height = 3508, res = 300,
...
for (page in 1:n_pages) {
  ...
  ggsave(
    filename = file.path(here("exp2", "img", paste0("individual_precsd_visd_plots_page_", page, ".png"))
    ),
    plot = p_rq2_precsd,
    width = 11,
    height = 8.5,
...
## Model Fit: Posterior Predictive Check ----
# Check whether model is "match to the data"
png(here("exp2", "img", "rq3_fixdur_ppc.png"), width = 2480/2, height = 3508/2, res = 200)
...
png(here("exp2", "img", "rq3_fixdur_posterior_3c.png"), width = 2480, height = 3508 / 4, res = 250)
...
# Plot prior and posterior distribution to see how sensitive the results are to the choice of priors
## Accuracy
png(here("exp2", "img", "rq3_fixdur_posteriorprior_4m_acc.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixdur_posteriorprior_6m_acc.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixdur_posteriorprior_9m_acc.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixdur_posteriorprior_18m_acc.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixdur_posteriorprior_adults_acc.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixdur_posteriorprior_chimps_acc.png"), width = 2480/2, height = 3508/3, res = 300)
...
## Precision (RMS)
png(here("exp2", "img", "rq3_fixdur_posteriorprior_4m_precrms.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixdur_posteriorprior_6m_precrms.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixdur_posteriorprior_9m_precrms.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixdur_posteriorprior_18m_precrms.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixdur_posteriorprior_adults_precrms.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixdur_posteriorprior_chimps_precrms.png"), width = 2480/2, height = 3508/3, res = 300)
...
## Robustness
png(here("exp2", "img", "rq3_fixdur_posteriorprior_4m_robustness.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixdur_posteriorprior_6m_robustness.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixdur_posteriorprior_9m_robustness.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixdur_posteriorprior_18m_robustness.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixdur_posteriorpriora_adults_robustness.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixdur_posteriorpriora_chimps_robustness.png"), width = 2480/2, height = 3508/3, res = 300)
...
## Model Fit: Posterior Predictive Check ----
# Check whether model is "match to the data"
png(here("exp2", "img", "rq3_fixnum_ppc.png"), width = 2480/2, height = 3508/2, res = 200)
...
png(here("exp2", "img", "rq3_fixnum_posterior_3c.png"), width = 2480, height = 3508 / 4, res = 250)
...
# Plot prior and posterior distribution to see how sensitive the results are to the choice of priors
## Accuracy
png(here("exp2", "img", "rq3_fixnum_posteriorprior_4m_acc.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixnum_posteriorprior_6m_acc.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixnum_posteriorprior_9m_acc.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixnum_posteriorprior_18m_acc.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixnum_posteriorprior_adults_acc.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixnum_posteriorprior_chimps_acc.png"), width = 2480/2, height = 3508/3, res = 300)
...
## Precision (RMS)
png(here("exp2", "img", "rq3_fixnum_posteriorprior_4m_precrms.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixnum_posteriorprior_6m_precrms.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixnum_posteriorprior_9m_precrms.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixnum_posteriorprior_18m_precrms.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixnum_posteriorprior_adults_precrms.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixnum_posteriorprior_chimps_precrms.png"), width = 2480/2, height = 3508/3, res = 300)
...
## Robustness
png(here("exp2", "img", "rq3_fixnum_posteriorprior_4m_robustness.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixnum_posteriorprior_6m_robustness.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixnum_posteriorprior_9m_robustness.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixnum_posteriorprior_18m_robustness.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixnum_posteriorprior_adults_robustness.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_fixnum_posteriorprior_chimps_robustness.png"), width = 2480/2, height = 3508/3, res = 300)
...
## Model Fit: Posterior Predictive Check ----
# Check whether model is "match to the data"
png(here("exp2", "img", "rq3_latencies_ppc.png"), width = 2480/2, height = 3508/2, res = 200)
...
png(here("exp2", "img", "rq3_latencies_posterior_3c.png"), width = 2480, height = 3508 / 4, res = 250)
...
# Plot prior and posterior distribution to see how sensitive the results are to the choice of priors
## Accuracy
png(here("exp2", "img", "rq3_latencies_posteriorprior_4m_acc.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_latencies_posteriorprior_6m_acc.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_latencies_posteriorprior_9m_acc.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_latencies_posteriorprior_18m_acc.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_latencies_posteriorprior_adults_acc.png"), width = 2480/2, height = 3508/3, res = 300)
...
## Precision (RMS)
png(here("exp2", "img", "rq3_latencies_posteriorprior_4m_precrms.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_latencies_posteriorprior_6m_precrms.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_latencies_posteriorprior_9m_precrms.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_latencies_posteriorprior_18m_precrms.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_latencies_posteriorprior_adults_precrms.png"), width = 2480/2, height = 3508/3, res = 300)
...
## Robustness
png(here("exp2", "img", "rq3_latencies_posteriorprior_4m_robustness.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_latencies_posteriorprior_6m_robustness.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_latencies_posteriorprior_9m_robustness.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_latencies_posteriorprior_18m_robustness.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_latencies_posteriorprior_adults_robustness.png"), width = 2480/2, height = 3508/3, res = 300)
...
## Model Fit: Posterior Predictive Check ----
# Check whether model is "match to the data"
png(here("exp2", "img", "rq3_rel_gaze_in_aoi_ppc.png"), width = 2480/2, height = 3508/2, res = 200)
...
png(here("exp2", "img", "rq3_rel_gaze_in_aoi_posterior_3c.png"), width = 2480, height = 3508 / 4, res = 250)
...
# Plot prior and posterior distribution to see how sensitive the results are to the choice of priors
## Accuracy
png(here("exp2", "img", "rq3_rel_gaze_in_aoi_posteriorprior_4m_acc.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_rel_gaze_in_aoi_posteriorprior_6m_acc.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_rel_gaze_in_aoi_posteriorprior_9m_acc.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_rel_gaze_in_aoi_posteriorprior_18m_acc.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_rel_gaze_in_aoi_posteriorprior_adults_acc.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_rel_gaze_in_aoi_posteriorprior_chimps_acc.png"), width = 2480/2, height = 3508/3, res = 300)
...
## Precision (RMS)
png(here("exp2", "img", "rq3_rel_gaze_in_aoi_posteriorprior_4m_precrms.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_rel_gaze_in_aoi_posteriorprior_6m_precrms.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_rel_gaze_in_aoi_posteriorprior_9m_precrms.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_rel_gaze_in_aoi_posteriorprior_18m_precrms.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_rel_gaze_in_aoi_posteriorprior_adults_precrms.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_rel_gaze_in_aoi_posteriorprior_chimps_precrms.png"), width = 2480/2, height = 3508/3, res = 300)
...
## Robustness
png(here("exp2", "img", "rq3_rel_gaze_in_aoi_posteriorprior_4m_robustness.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_rel_gaze_in_aoi_posteriorprior_6m_robustness.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_rel_gaze_in_aoi_posteriorprior_9m_robustness.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_rel_gaze_in_aoi_posteriorprior_18m_robustness.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_rel_gaze_in_aoi_posteriorprior_adults_robustness.png"), width = 2480/2, height = 3508/3, res = 300)
...
png(here("exp2", "img", "rq3_rel_gaze_in_aoi_posteriorprior_chimps_robustness.png"), width = 2480/2, height = 3508/3, res = 300)
...
tobii_4m <- read_excel(here("exp2", "doc", "protocol.xlsx"), sheet = 1) |> 
  mutate(
    folder = "4m",
...
tobii_6m <- read_excel(here("exp2", "doc", "protocol.xlsx"), sheet = 2) |> 
  mutate(
    folder = "6m",
    file = as.character(file),
    tobii_average_calibration_accuracy_degree = as.numeric(tobii_average_calibration_accuracy_degree),
...
tobii_9m <- read_excel(here("exp2", "doc", "protocol.xlsx"), sheet = 3) |> 
  mutate(
    folder = "9m",
    file = as.character(file),
    tobii_average_calibration_accuracy_degree = as.numeric(tobii_average_calibration_accuracy_degree),
...
tobii_18m <- read_excel(here("exp2", "doc", "protocol.xlsx"), sheet = 4) |> 
  mutate(
    folder = "18m",
    file = as.character(file),
    tobii_average_calibration_accuracy_degree = as.numeric(tobii_average_calibration_accuracy_degree),
...
tobii_adults <- read_excel(here("exp2", "doc", "protocol.xlsx"), sheet = 5) |> 
  mutate(
    folder = "adults",
    file = as.character(file),
    tobii_average_calibration_accuracy_degree = as.numeric(tobii_average_calibration_accuracy_degree),
...
tobii_chimps <- read_excel(here("exp2", "doc", "protocol.xlsx"), sheet = 6) |> 
  mutate(
    folder = "chimps",
    file = as.character(file),
    tobii_average_calibration_accuracy_degree = as.numeric(tobii_average_calibration_accuracy_degree),
...
#png(here("exp2", "img", "explorative_tobii_versus_own.png"), width = 2480, height = 3508/2.5, res = 280)
png(here("exp2", "img", "explorative_tobiivalidation_versus_own.png"), width = 2480, height = 3508/2.5, res = 280)
